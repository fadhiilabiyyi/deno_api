...
class BeerRepository {
  ...
  update(id, beer) {
    ...
    return client.queryArray`UPDATE beers set name = ${beer.name !== undefined ? beer.name : latestBeer.name}, brand = ${beer.brand !== undefined ? beer.brand : latestBeer.brand}, is_premium = ${
